...
class Migration_Install_product extends Migration {
	...
	public function up() 
	{
		...
		$this->dbforge->add_field('`id` int(11) NOT NULL AUTO_INCREMENT');
			...
			$this->dbforge->add_field("`product_special_price` DECIMAL(12,4) NOT NULL");
			$this->dbforge->add_field("`product_special_price_from_date` DATETIME NOT NULL");
			$this->dbforge->add_field("`product_special_price_to_date` DATETIME NOT NULL");
			...
			$this->dbforge->add_field("`product_meta_description` TEXT NOT NULL");
			$this->dbforge->add_field("`product_meta_keywords` TEXT NOT NULL");
