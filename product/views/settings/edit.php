...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit Product" onclick="javascript:CKEDITOR.instances.product_description.destroy();CKEDITOR.instances.product_meta_description.destroy();CKEDITOR.instances.product_meta_keywords.destroy();" /> or <?php echo anchor(SITE_AREA .'/settings/product', lang('product_cancel')); ?>
	</div>
	<?php echo form_close(); ?>
