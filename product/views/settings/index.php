<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Product.Settings.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Product.Settings.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/settings/product/edit/'. $record->id, '<i class="icon-pencil">&nbsp;</i>' .  $record->product_sku) ?></td>
				<?php else: ?>
