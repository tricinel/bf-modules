...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/reports/product', lang('product_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Product.Reports.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="/<?php echo SITE_AREA .'/reports/product/delete/'. $id;?>" onclick="return confirm('<?php echo lang('product_delete_confirm'); ?>')" name="delete-me">
