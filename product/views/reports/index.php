<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/reports/product/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/reports/product/edit/'. $record->id, lang('product_edit'), '') ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
