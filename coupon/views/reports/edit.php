...
<div>
        ...
        <input id="coupon_allowed_for_guests" type="text" name="coupon_allowed_for_guests" maxlength="1" value="<?php echo set_value('coupon_allowed_for_guests', isset($coupon['coupon_allowed_for_guests']) ? $coupon['coupon_allowed_for_guests'] : ''); ?>"  />
</div>
...
<div>
        <?php echo form_label('Times used', 'coupon_times_used'); ?>
        <input id="coupon_times_used" type="text" name="coupon_times_used" maxlength="11" value="<?php echo set_value('coupon_times_used', isset($coupon['coupon_times_used']) ? $coupon['coupon_times_used'] : ''); ?>"  />
</div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit Coupon" /> or <?php echo anchor(SITE_AREA .'/reports/coupon', lang('coupon_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/reports/coupon/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('coupon_delete_confirm'); ?>')"><?php echo lang('coupon_delete_record'); ?></a>
		
		<h3><?php echo lang('coupon_delete_record'); ?></h3>
