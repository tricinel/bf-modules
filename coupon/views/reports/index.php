<div class="box create rounded">
	...
	<a class="button good" href="<?php echo site_url(SITE_AREA .'/reports/coupon/create'); ?>">
	...
	<table>
		...
		<?php foreach ($records as $record) : ?>
			<tr>
				...
				<td><?php echo anchor(SITE_AREA .'/reports/coupon/edit/'. $record->id, lang('coupon_edit'), '') ?></td>
			</tr>
		<?php endforeach; ?>
		</tbody>
	</table>
