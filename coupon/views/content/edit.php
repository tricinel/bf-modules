...
<div>
	...
	<div class="text-right">
		<br/>
		<input type="submit" name="submit" value="Edit Coupon" /> or <?php echo anchor(SITE_AREA .'/content/coupon', lang('coupon_cancel')); ?>
	</div>
	<?php echo form_close(); ?>

	<div class="box delete rounded">
		<a class="button" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/coupon/delete/'. $id); ?>" onclick="return confirm('<?php echo lang('coupon_delete_confirm'); ?>')"><?php echo lang('coupon_delete_record'); ?></a>
